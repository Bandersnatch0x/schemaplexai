package com.schemaplexai.agent.engine.manifest;
...
public class AgentsManifestParser {
    ...
    private int findClosingDelimiter(String text) {
        // Look for "\n---\n" or "\n---" at end-of-string, or at very start (yaml empty)
    ...
    private Map<String, Object> parseYaml(String yamlText) {
        ...
        try {
            ...
            // unchecked: snakeyaml SafeConstructor returns Map<String,Object> for mappings
