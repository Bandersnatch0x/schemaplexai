---
name: "source-command-expert-architecture"
description: "ArchitectureAuditor —— 锁定 16 模块边界、数据流、隐藏假设公开化"
---

# source-command-expert-architecture

Use this skill when the user asks to run the migrated source command `expert-architecture`.
