---
name: "source-command-expert-moderator"
description: "PlanModerator —— 合并 7 专家报告 → MASTER.md，跨域冲突仲裁，Δ 摘要"
---

# source-command-expert-moderator

Use this skill when the user asks to run the migrated source command `expert-moderator`.
...
- 最近 loop：`.Codex/plans/v1-readiness/loop-<最近日期>.md`
