---
name: "source-command-expert-design-system"
description: "DesignSystemLead —— 从零构建设计系统，竞品调研，亮/暗双主题"
---

# source-command-expert-design-system

Use this skill when the user asks to run the migrated source command `expert-design-system`.
