---
name: "source-command-expert-product"
description: "ProductStrategist —— 从隐藏需求挖出\"十星级产品\"，4 模式范围决策"
---

# source-command-expert-product

Use this skill when the user asks to run the migrated source command `expert-product`.
...
- `README.md`、根 `AGENTS.md`
- `docs/specs/*.md`（8 份 spec）
- `docs/reviews/v1-readiness/product-strategy.md`（上一轮基线，本轮覆盖）
- `.Codex/outputs/2026-05-07/code-review-report.md`、`security-review-report.md`（4 份评审）
